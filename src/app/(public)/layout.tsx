    ...
    <div className="min-h-screen flex flex-col">
      ...
      {whatsapp && (
        <a
          ...
          className="fixed bottom-34 md:bottom-34 right-4 md:right-8 z-[100] bg-whatsapp-green text-white w-14 h-14 md:w-16 md:h-16 flex items-center justify-center rounded-full shadow-xl hover:shadow-whatsapp-green/25 hover:scale-110 active:scale-95 transition-all duration-300 group"
